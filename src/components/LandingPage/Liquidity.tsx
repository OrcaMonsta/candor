      ...
      <Center px={[8, 0]}>
        <Flex direction="column" align="center">
          <Heading fontWeight={500} fontSize="3rem" lineHeight={'3.8rem'} color={colors.primary}>
            9mm Solana Dex provides Ecosystem-Wide
          </Heading>
          <Heading fontWeight={500} fontSize="3rem" lineHeight={'3.8rem'} color={colors.primary}>
          ...
          <Flex gap="45px" mt="99px" flexWrap="wrap">
            ...
            <Flex direction="column" justify="space-between" align="center" className="landing-liquidity-card">
              ...
              <Box h={'fit-content'}>
                ...
                <CardBody>
                  9mm Solana Dex determines whether swapping within a liquidity pool or through the Serum order book will provide the best price
