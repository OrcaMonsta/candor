import { Box, Flex, HStack, Text, useColorMode, useDisclosure } from '@chakra-ui/react'
...
export default function AddLiquidity({
  ...
  return (
    <Flex direction="column" w="full" px="24px" py="40px"
    // bg={colors.backgroundTransparent11}
    >
      {/* modal */}
      {/* <AutoSwapModal
      ...
      {/* base token */}
      <Flex mt={5} justify="center" align="center" w={InputWidth} h="118px" borderRadius="12px" px={2} pb={8}>
        <TokenInput
          width="100%"
          ctrSx={{ w: '100%' }}
          topBlockSx={{ py: '6px' }}
          tokenIconMarginL={'10px'}
      ...
      {/* quote token */}
      <Box
        background={colorMode !== "dark" ? colors.cardLayoutBg01 : colors.cardLayoutBg01}
        rounded={colorMode !== "dark" ? "18px" : ""}
      >

        <Flex mt={10} justify="center" align="center" w={InputWidth} h="118px" borderRadius="12px" px={2} pb={8}>
          <TokenInput
            width="100%"
            ctrSx={{ w: '100%' }}
            topBlockSx={{ py: '6px' }}
